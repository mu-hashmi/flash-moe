...
No `devstral` model file in `PATH_REMOVED Devstral models likely map to `llama` or `mistral3` via `MODEL_REMAPPING` since they're dense Mistral variants.
...
- `PATH_REMOVED -- for GLM-4.5/4.6/4.7 (model_type: `glm4_moe`)
- `PATH_REMOVED -- for GLM-4.7-Flash (model_type: `glm4_moe_lite`)
