...
def main():
    ...
    with open("/Users/muhash/flash-moe/final_validation.md", "w") as f:
        f.write("# Flash-MoE Final Validation Results\n\n")
    ...
    print("\nResults written to /Users/muhash/flash-moe/final_validation.md")
